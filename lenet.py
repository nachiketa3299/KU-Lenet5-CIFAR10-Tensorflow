...
class LeNet:
    def __init__(self, config):
        ...
        self.C1 = tf.nn.relu(tf.nn.conv2d(self.X, self.conv_f1, strides=[1, 1, 1, 1], padding='SAME'))
        ...
        self.C3 = tf.nn.relu(tf.nn.conv2d(self.S2, self.conv_f2, strides=[1, 1, 1, 1], padding='SAME'))
