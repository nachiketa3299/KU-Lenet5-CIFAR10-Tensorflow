class Preset:
    ...
    def __init__(self, preset_num=1):
        ...
        if preset_num == 1:
            setParameters(128, 'relu', 0.01, 'adam', 0.001, 200, 0.1, 0.0, False, 1.0, 0)
        elif preset_num == 2:
            setParameters(128, 'relu', 0.01, 'adam', 0.001, 200, 0.1, 0.0001, False, 1.0, 0)
        elif preset_num == 3:
            setParameters(128, 'relu', 0.01, 'adam', 0.001, 200, 0.1, 0.0001, True, 1.0, 0)
        elif preset_num == 4:
            setParameters(128, 'relu', 'he', 'adam', 0.001, 200, 0.1, 0.0001, True, 0.96, 5000)
